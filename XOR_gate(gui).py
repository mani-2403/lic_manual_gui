...
class XorGateCircuit(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Transistor XOR Gate Circuit")
    ...
    def paintEvent(self, event):
        ...
        # XOR logic:
        xor_on = self.switch1_on and (
            (self.switch2_on and not self.switch3_on) or
            (not self.switch2_on and self.switch3_on)
        )
        ...
        self.draw_block(painter, *bx['led'], 100, 40, "LED", "yellow" if xor_on else "lightgray")
