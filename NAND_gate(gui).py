...
class NandGateCircuit(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Transistor NAND Gate Circuit")
    ...
    def paintEvent(self, event):
        ...
        bx = {
            ...
            'transistor1': (600, 180),  # Shared input from R1 & R2
            'transistor2': (750, 200),
        ...
        self.draw_block(painter, *bx['led'], 100, 40, "LED", "yellow" if not (self.switch1_on and self.switch2_on and self.switch3_on) else "lightgray")
...
# Optional: tick marks on axes
        ...
        # Power path
        line(250, 220, 300, 220)  # Battery+ to Switch 1
        line(400, 220, 450, 220)  # Switch 1 to Resistor3
        line(550, 220, 600, 220)  # Resistor3 to Transistor2 (base)

        # Switch1 also connects to Switch2 and Switch3
        line(350, 300, 350, 240)
        line(350, 200, 350, 120)

        # Switch2 to Resistor1 to Transistor1
        line(400, 120, 450, 120)
        line(550, 120, 600, 200)
        line(750, 180, 750, 200)# to T1 base

        # Switch3 to Resistor2 to Transistor1
        line(400, 320, 450, 320)
        line(550, 320, 600, 200)

        # Transistor1 collector to Vcc (via Switch1 path)
        line(600 + 50, 180, 750, 180)  # T1 collector to T2 base

        # Transistor2 collector to LED
        line(850, 220, 900, 220)

        # LED to Ground
        line(950, 240, 950, 370)
        line(950, 370, 850, 370)
        line(800, 260, 800, 350)  # T2 emitter to battery(−)

    # NAND = output OFF only when all inputs ON
