...
class AndGateCircuit(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Transistor AND Gate Circuit")
    ...
    def paintEvent(self, event):
        ...
        bx = {
            ...
            'transistor1': (600, 200),  # Q1
            'transistor2': (750, 200),  # Q2
        ...
        self.draw_block(painter, *bx['transistor1'], 100, 60, "Transistor Q1")
        self.draw_block(painter, *bx['transistor2'], 100, 60, "Transistor Q2")
        self.draw_block(
            painter, *bx['led'], 100, 40,
            "LED", "yellow" if (self.switch1_on and self.switch2_on and self.switch3_on) else "lightgray"
        )
        ...
        line(400, 220, 450, 220)  # Switch1 to R3
        line(550, 220, 600, 220)  # R3 to Q1 Collector
        line(700, 220, 750, 220)  # Q1 emitter to Q2 collector
        line(850, 220, 900, 220)  # Q2 emitter to LED
        line(950, 240, 950, 370)  # LED to Battery(-)

        # Battery(-) back
        line(950, 370, 850, 370)
        line(800, 260, 800, 350)

        # Switch1 branching to Switch2 and Switch3
        line(350, 200, 350, 140)
        line(350, 240, 350, 300)

        # Top path: Switch2 to Resistor1 to Q1 base
        line(400, 120, 450, 120)
        line(550, 120, 600, 120)
        line(600, 120, 600, 200)

        # Bottom path: Switch3 to Resistor2 to Q2 base
        line(400, 320, 450, 320)
        line(550, 320, 750, 320)
        line(750, 320, 750, 260 )

        # Axes for layout reference
